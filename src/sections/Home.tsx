  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 flex flex-col items-center justify-center w-full h-full text-center max-w-3xl mx-auto px-4">
        ...
        />
        <h1 className="text-6xl md:text-7xl font-artout mb-1 sm:mb-2 text-white transition-all duration-500">
          ArtOut
        </h1>
        <p className="mt-1 text-2xl md:text-3xl text-white/90 font-semibold font-sunda mb-2 sm:mb-3">
          Graffiti & Street Art Around the World
        </p>
        <p className="mt-1 max-w-2xl mx-auto text-lg md:text-xl text-white/80 font-akadylan mb-3 sm:mb-4 text-center">
        ...
        <a
          href="#features"
          className="inline-block bg-pink-600 text-white font-sunda font-bold px-8 py-3 rounded-full shadow-lg hover:bg-yellow-400 hover:text-black transition-colors duration-300 text-lg mt-1"
        >
          Explore Features
        </a>
      </div>
