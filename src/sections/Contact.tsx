export default function Contact() {
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="relative z-10 max-w-2xl mx-auto px-2 sm:px-4">
        <div
          className="relative text-center bg-black/50 backdrop-blur-md rounded-2xl p-6 sm:p-8 shadow-lg ring-1 ring-white/6"
          aria-hidden="false"
        >
          <h2
            className="text-5xl font-extrabold mb-4 text-artout-yellow font-sunda"
        ...
        <div className="h-px bg-gradient-to-r from-transparent via-gray-700/40 to-transparent mt-8" />
      </div>
    </section>
  );
}
