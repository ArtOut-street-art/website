    ...
    <nav className="bg-[#18181b] border-b border-gray-800 shadow-lg sticky top-0 z-50 transition-all duration-300">
      <div className="max-w-7xl mx-auto flex justify-between items-center py-4 px-6">
        <a href="#home" className="flex items-center gap-2">
          <span className="text-7xl md:text-8xl text-white font-artout drop-shadow">
            ArtOut
          </span>
        </a>
        <button
        ...
        >
          <div className="flex flex-col md:flex-row md:space-x-8 text-white text-lg px-6 md:px-0 py-4 md:py-0 justify-end items-end md:items-center">
            <a
              href="#home"
