      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 px-4 sm:px-6 items-center">
        <div className="flex flex-col items-start">
          <div className="flex items-center mb-4">
            ...
            <h3 className="text-4xl font-artout font-bold text-pink-400 drop-shadow tracking-tight mb-2">
              Our Mission
            </h3>
          </div>
        ...
        <div className="flex flex-col items-start">
          <div className="flex items-center mb-4">
            ...
            <h3 className="text-4xl font-artout font-bold text-yellow-400 drop-shadow tracking-tight mb-2">
              Our Vision
            </h3>
          </div>
          <p className="text-lg text-gray-200 font-akadylan mb-2">
